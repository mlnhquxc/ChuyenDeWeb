        ...
        return (
            <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 py-12">
                <div className="text-center">
                    ...
                    <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Danh sách yêu thích của bạn đang trống</h2>
                    <p className="text-gray-600 dark:text-gray-300 mb-8">Hãy thêm sản phẩm vào danh sách yêu thích để xem sau</p>
                    <Link
                        to="/store"
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden transition-colors duration-200">
                <div className="divide-y divide-gray-200 dark:divide-gray-700">
                    {wishlistItems.map((item) => {
                        ...
                        return (
                            <div key={itemId} className="p-6 flex flex-col sm:flex-row items-center gap-6 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-200">
                                ...
                                <div className="flex-1 min-w-0">
                                    <Link to={`/product/${productId}`}>
                                        <h3 className="text-lg font-semibold text-gray-800 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors duration-200">{productName}</h3>
                                    </Link>
