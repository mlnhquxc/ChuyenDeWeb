    ...
    return (
      <div className="flex justify-center items-center h-64">
        <div className="flex flex-col items-center">
          ...
          <p className="text-rose-500 font-medium">Đang tải danh sách yêu thích...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 py-12">
        <div className="text-center max-w-md mx-auto">
          <div className="mb-8 flex justify-center">
            <div className="w-32 h-32 rounded-full bg-gradient-to-br from-rose-200 to-pink-200 flex items-center justify-center text-rose-700 shadow-xl animate-pulse">
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 mt-3">Những sản phẩm bạn yêu thích nhất</p>
      </div>

      <div className="bg-gray-50 rounded-2xl shadow-xl border border-gray-200 overflow-hidden transition-all duration-300">
        <div className="divide-y divide-gray-200 dark:divide-gray-700">
          {wishlistItems.map((item) => {
            ...
            return (
              <div
                key={itemId}
                className="p-6 flex flex-col sm:flex-row items-center gap-6 hover:bg-gradient-to-r hover:from-rose-100 hover:to-pink-100 transition-all duration-300 group"
              >
                <Link to={`/product/${productId}`} className="flex-shrink-0 group-hover:scale-105 transition-transform duration-300">
                  <div className="w-28 h-28 bg-gradient-to-br from-rose-200 to-pink-200 rounded-xl overflow-hidden shadow-md">
                    <ProductImage
                ...
                <div className="flex-1 min-w-0 text-center sm:text-left">
                  ...
                  <div className="bg-gradient-to-r from-rose-200 to-pink-200 rounded-lg p-3 inline-block border border-rose-300 dark:border-gray-600">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-3">
                  <button
                    ...
                    className="flex items-center justify-center px-6 py-3 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold transition-all duration-300 transform hover:scale-[1.05] shadow-lg hover:shadow-emerald-200 disabled:opacity-70"
                  ...
                  <button
                    ...
                    className="p-3 rounded-xl bg-gradient-to-r from-rose-200 to-pink-200 text-rose-700 hover:from-rose-300 hover:to-pink-300 border-2 border-rose-300 shadow-md hover:shadow-lg transition-all duration-300 hover:scale-110 disabled:opacity-50"
      ...
      <div className="mt-10 text-center">
        <Link
          to="/store"
          className="inline-flex items-center px-8 py-4 rounded-xl border-2 border-rose-200 text-rose-700 font-bold text-lg hover:bg-gradient-to-r hover:from-rose-50 hover:to-pink-50 transition-all duration-300 hover:scale-[1.02] shadow-md hover:shadow-lg"
        >
